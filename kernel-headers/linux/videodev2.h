...
#define V4L2_EVENT_MSM_CVP_PORT_SETTINGS_CHANGED_SUFFICIENT (V4L2_EVENT_MSM_CVP_START + 2)
#define V4L2_EVENT_MSM_CVP_PORT_SETTINGS_CHANGED_INSUFFICIENT (V4L2_EVENT_MSM_CVP_START + 3)
#define V4L2_EVENT_MSM_CVP_SYS_ERROR (V4L2_EVENT_MSM_CVP_START + 5)
#define V4L2_EVENT_MSM_CVP_RELEASE_BUFFER_REFERENCE (V4L2_EVENT_MSM_CVP_START + 6)
#define V4L2_EVENT_MSM_CVP_RELEASE_UNQUEUED_BUFFER (V4L2_EVENT_MSM_CVP_START + 7)
...
#define V4L2_EVENT_MSM_CVP_REGISTER_BUFFER_DONE (V4L2_EVENT_MSM_CVP_START + 11)
#define V4L2_EVENT_MSM_CVP_UNREGISTER_BUFFER_DONE (V4L2_EVENT_MSM_CVP_START + 12)
