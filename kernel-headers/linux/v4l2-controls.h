...
#define V4L2_CID_MPEG_VIDC_VIDEO_RATE_CONTROL_MBR_CFR V4L2_CID_MPEG_VIDC_VIDEO_RATE_CONTROL_MBR_CFR
#define V4L2_CID_MPEG_VIDC_VIDEO_RATE_CONTROL_MBR_VFR V4L2_CID_MPEG_VIDC_VIDEO_RATE_CONTROL_MBR_VFR
...
#define V4L2_CID_MPEG_VIDC_VIDEO_H264_CABAC_MODEL (V4L2_CID_MPEG_MSM_VIDC_BASE + 11)
...
#define EXTRADATA_NONE EXTRADATA_NONE
  EXTRADATA_NONE = 0,
  EXTRADATA_DEFAULT = 1,
...
#define V4L2_MPEG_VIDC_EXTRADATA_ENC_DTS V4L2_MPEG_VIDC_EXTRADATA_ENC_DTS
...
#define V4L2_MPEG_VIDC_EXTRADATA_INPUT_CROP V4L2_MPEG_VIDC_EXTRADATA_INPUT_CROP
...
#define V4L2_MPEG_VIDC_EXTRADATA_PQ_INFO V4L2_MPEG_VIDC_EXTRADATA_PQ_INFO
  V4L2_MPEG_VIDC_EXTRADATA_PQ_INFO = 28,
#define V4L2_MPEG_VIDC_EXTRADATA_VUI_DISPLAY V4L2_MPEG_VIDC_EXTRADATA_VUI_DISPLAY
  V4L2_MPEG_VIDC_EXTRADATA_VUI_DISPLAY = 29,
#define V4L2_MPEG_VIDC_EXTRADATA_VPX_COLORSPACE V4L2_MPEG_VIDC_EXTRADATA_VPX_COLORSPACE
  V4L2_MPEG_VIDC_EXTRADATA_VPX_COLORSPACE = 30,
#define V4L2_MPEG_VIDC_EXTRADATA_UBWC_CR_STATS_INFO V4L2_MPEG_VIDC_EXTRADATA_UBWC_CR_STATS_INFO
...
#define V4L2_MPEG_CVP_EXTRADATA_HDR10PLUS_METADATA V4L2_MPEG_CVP_EXTRADATA_HDR10PLUS_METADATA
...
#define V4L2_CID_MPEG_VIDC_VIDEO_PRESERVE_TEXT_QUALITY (V4L2_CID_MPEG_MSM_VIDC_BASE + 21)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_CONCEAL_COLOR (V4L2_CID_MPEG_MSM_VIDC_BASE + 25)
#define V4L2_CID_MPEG_VIDC_VIDEO_LTRMODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 26)
...
#define V4L2_MPEG_VIDC_VIDEO_HEVC_LEVEL_UNKNOWN V4L2_MPEG_VIDC_VIDEO_HEVC_LEVEL_UNKNOWN
...
#define V4L2_CID_VIDC_QBUF_MODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 45)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_VQZIP_SEI (V4L2_CID_MPEG_MSM_VIDC_BASE + 50)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_BLUR_WIDTH (V4L2_CID_MPEG_MSM_VIDC_BASE + 58)
#define V4L2_CID_MPEG_VIDC_VIDEO_BLUR_HEIGHT (V4L2_CID_MPEG_MSM_VIDC_BASE + 59)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_COLOR_SPACE_CAPS (V4L2_CID_MPEG_MSM_VIDC_BASE + 68)
#define V4L2_CID_MPEG_VIDC_VIDEO_ROTATION_CAPS (V4L2_CID_MPEG_MSM_VIDC_BASE + 69)
#define V4L2_CID_MPEG_VIDC_VIDEO_MB_ERROR_MAP_REPORTING (V4L2_CID_MPEG_MSM_VIDC_BASE + 70)
#define V4L2_CID_MPEG_VIDC_VIDEO_CONTINUE_DATA_TRANSFER (V4L2_CID_MPEG_MSM_VIDC_BASE + 71)
#define V4L2_CID_MPEG_VIDC_VIDEO_ALLOC_MODE_INPUT (V4L2_CID_MPEG_MSM_VIDC_BASE + 72)
#define V4L2_CID_MPEG_VIDC_VIDEO_FRAME_ASSEMBLY (V4L2_CID_MPEG_MSM_VIDC_BASE + 73)
enum v4l2_mpeg_vidc_video_assembly {
  V4L2_MPEG_VIDC_FRAME_ASSEMBLY_DISABLE = 0,
  V4L2_MPEG_VIDC_FRAME_ASSEMBLY_ENABLE = 1,
};
#define V4L2_CID_MPEG_VIDC_VIDEO_H263_PROFILE (V4L2_CID_MPEG_MSM_VIDC_BASE + 74)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_OUTPUT_ORDER (V4L2_CID_MPEG_MSM_VIDC_BASE + 75)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_H264_TRANSFORM_8x8 (V4L2_CID_MPEG_MSM_VIDC_BASE + 76)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_QP_MASK (V4L2_CID_MPEG_MSM_VIDC_BASE + 77)
#define V4L2_CID_MPEG_VIDEO_MIN_QP_PACKED (V4L2_CID_MPEG_MSM_VIDC_BASE + 96)
#define V4L2_CID_MPEG_VIDEO_MAX_QP_PACKED (V4L2_CID_MPEG_MSM_VIDC_BASE + 97)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_ROI_TYPE (V4L2_CID_MPEG_MSM_VIDC_BASE + 127)
...
#define V4L2_CID_MPEG_VIDC_SET_PERF_LEVEL (V4L2_CID_MPEG_MSM_VIDC_BASE + 128)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_H264_VUI_TIMING_INFO (V4L2_CID_MPEG_MSM_VIDC_BASE + 137)
#define V4L2_CID_MPEG_VIDEO_MULTI_SLICE_GOB (V4L2_CID_MPEG_MSM_VIDC_BASE + 138)
#define V4L2_CID_MPEG_VIDC_VIDEO_H264_VUI_BITSTREAM_RESTRICT (V4L2_CID_MPEG_MSM_VIDC_BASE + 139)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_DEINTERLACE (V4L2_CID_MPEG_MSM_VIDC_BASE + 140)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_MPEG4_TIME_RESOLUTION (V4L2_CID_MPEG_MSM_VIDC_BASE + 141)
#define V4L2_CID_MPEG_VIDC_VIDEO_REQUEST_SEQ_HEADER (V4L2_CID_MPEG_MSM_VIDC_BASE + 142)
#define V4L2_CID_MPEG_VIDC_VIDEO_RATE_CONTROL_TIMESTAMP_MODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 143)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_ENABLE_INITIAL_QP (V4L2_CID_MPEG_MSM_VIDC_BASE + 144)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_INITIAL_I_FRAME_QP (V4L2_CID_MPEG_MSM_VIDC_BASE + 145)
#define V4L2_CID_MPEG_VIDC_VIDEO_INITIAL_P_FRAME_QP (V4L2_CID_MPEG_MSM_VIDC_BASE + 146)
#define V4L2_CID_MPEG_VIDC_VIDEO_INITIAL_B_FRAME_QP (V4L2_CID_MPEG_MSM_VIDC_BASE + 147)
#define V4L2_CID_MPEG_VIDC_VIDEO_H264_NAL_SVC (V4L2_CID_MPEG_MSM_VIDC_BASE + 148)
#define V4L2_CID_MPEG_VIDC_VIDEO_PERF_MODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 149)
enum v4l2_mpeg_vidc_video_perf_mode {
  V4L2_MPEG_VIDC_VIDEO_PERF_MAX_QUALITY = 1,
  V4L2_MPEG_VIDC_VIDEO_PERF_POWER_SAVE = 2
};
#define V4L2_CID_MPEG_VIDC_VIDEO_MBI_STATISTICS_MODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 150)
#define V4L2_CID_MPEG_VIDC_VIDEO_CONFIG_QP (V4L2_CID_MPEG_MSM_VIDC_BASE + 151)
#define V4L2_CID_MPEG_VIDC_VIDEO_H264_PIC_ORDER_CNT (V4L2_CID_MPEG_MSM_VIDC_BASE + 152)
#define V4L2_CID_MPEG_VIDC_VIDEO_SCS_THRESHOLD (V4L2_CID_MPEG_MSM_VIDC_BASE + 153)
#define V4L2_CID_MPEG_VIDC_VIDEO_MVC_BUFFER_LAYOUT (V4L2_CID_MPEG_MSM_VIDC_BASE + 154)
#define V4L2_CID_MPEG_VIDC_VIDEO_SECURE_SCALING_THRESHOLD (V4L2_CID_MPEG_MSM_VIDC_BASE + 155)
#define V4L2_CID_MPEG_VIDC_VIDEO_NON_SECURE_OUTPUT2 (V4L2_CID_MPEG_MSM_VIDC_BASE + 156)
...
#define V4L2_CID_MPEG_VIDC_VIDEO_POST_LOOP_DEBLOCKER_MODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 160)
...
#define V4L2_CID_MPEG_VIDC_IMG_GRID_DIMENSION (V4L2_CID_MPEG_MSM_VIDC_BASE + 163)
#define V4L2_CID_MPEG_VIDC_VIDEO_FRAME_QP (V4L2_CID_MPEG_MSM_VIDC_BASE + 164)
#define V4L2_CID_MPEG_VIDC_VIDEO_INTRA_REFRESH_MODE (V4L2_CID_MPEG_MSM_VIDC_BASE + 165)
